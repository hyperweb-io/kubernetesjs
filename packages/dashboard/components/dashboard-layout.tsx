...
const infraNavigation = [
  ...
  // removed Templates from infra navigation
...
const adminNavigation = [
  ...
  { id: 'admin-templates', label: 'Templates', icon: FileCode2, href: '/admin/templates' },
];
