    ...
    const initFS = async () => {
      try {
        ...
        const initialFiles = [
          ...
          { path: '/project/index.html', type: 'file', content: '<!DOCTYPE html>\n<html>\n<head>\n  <title>My Web App</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <h1>Hello World!</h1>\n  <script src="script.js"></script>\n</body>\n</html>' },
          { path: '/project/style.css', type: 'file', content: 'body {\n  font-family: Arial, sans-serif;\n  margin: 0;\n  padding: 20px;\n  background-color: #f0f0f0;\n}\n\nh1 {\n  color: #333;\n}' },
          { path: '/project/script.js', type: 'file', content: 'console.log("Hello from script.js!");\n\n// Your JavaScript code here' },
          { path: '/project/README.md', type: 'file', content: '# My Web App\n\nThis is a sample web application created in the IDE.' }
        ]
