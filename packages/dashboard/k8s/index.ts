...
import {
  ...
  APIResourceList,
  ListCoreV1ComponentStatusRequest,
  ReadCoreV1ComponentStatusRequest,
  ComponentStatus,
  ComponentStatusList,
  ListCoreV1ConfigMapForAllNamespacesRequest,
  ListCoreV1EndpointsForAllNamespacesRequest,
  ListCoreV1EventForAllNamespacesRequest,
  ListCoreV1LimitRangeForAllNamespacesRequest,
  ListCoreV1NamespaceRequest,
  CreateCoreV1NamespaceRequest,
  CreateCoreV1NamespacedBindingRequest,
  ListCoreV1NamespacedConfigMapRequest,
  CreateCoreV1NamespacedConfigMapRequest,
  DeleteCoreV1CollectionNamespacedConfigMapRequest,
  ReadCoreV1NamespacedConfigMapRequest,
  ReplaceCoreV1NamespacedConfigMapRequest,
  DeleteCoreV1NamespacedConfigMapRequest,
  PatchCoreV1NamespacedConfigMapRequest,
  ListCoreV1NamespacedEndpointsRequest,
  CreateCoreV1NamespacedEndpointsRequest,
  DeleteCoreV1CollectionNamespacedEndpointsRequest,
  ReadCoreV1NamespacedEndpointsRequest,
  ReplaceCoreV1NamespacedEndpointsRequest,
  DeleteCoreV1NamespacedEndpointsRequest,
  PatchCoreV1NamespacedEndpointsRequest,
  ListCoreV1NamespacedEventRequest,
  CreateCoreV1NamespacedEventRequest,
  DeleteCoreV1CollectionNamespacedEventRequest,
  ReadCoreV1NamespacedEventRequest,
  ReplaceCoreV1NamespacedEventRequest,
  DeleteCoreV1NamespacedEventRequest,
  PatchCoreV1NamespacedEventRequest,
  ListCoreV1NamespacedLimitRangeRequest,
  CreateCoreV1NamespacedLimitRangeRequest,
  DeleteCoreV1CollectionNamespacedLimitRangeRequest,
  ReadCoreV1NamespacedLimitRangeRequest,
  ReplaceCoreV1NamespacedLimitRangeRequest,
  DeleteCoreV1NamespacedLimitRangeRequest,
  PatchCoreV1NamespacedLimitRangeRequest,
  ListCoreV1NamespacedPersistentVolumeClaimRequest,
  CreateCoreV1NamespacedPersistentVolumeClaimRequest,
  DeleteCoreV1CollectionNamespacedPersistentVolumeClaimRequest,
  ...
  ReadCoreV1NamespacedPersistentVolumeClaimStatusRequest,
  ReplaceCoreV1NamespacedPersistentVolumeClaimStatusRequest,
  PatchCoreV1NamespacedPersistentVolumeClaimStatusRequest,
  ListCoreV1NamespacedPodRequest,
  CreateCoreV1NamespacedPodRequest,
  DeleteCoreV1CollectionNamespacedPodRequest,
  ReadCoreV1NamespacedPodRequest,
  ReplaceCoreV1NamespacedPodRequest,
  DeleteCoreV1NamespacedPodRequest,
  PatchCoreV1NamespacedPodRequest,
  ...
  ConnectCoreV1GetNamespacedPodProxyRequest,
  ConnectCoreV1PostNamespacedPodProxyRequest,
  ConnectCoreV1PutNamespacedPodProxyRequest,
  ...
  ConnectCoreV1DeleteNamespacedPodProxyWithPathRequest,
  ConnectCoreV1PatchNamespacedPodProxyWithPathRequest,
  ReadCoreV1NamespacedPodStatusRequest,
  ReplaceCoreV1NamespacedPodStatusRequest,
  ...
  Namespace,
  Pod,
  ConnectCoreV1GetNodeProxyWithPathRequest,
  ConnectCoreV1PostNodeProxyWithPathRequest,
  ConnectCoreV1PutNodeProxyWithPathRequest,
  ConnectCoreV1DeleteNodeProxyWithPathRequest,
  ConnectCoreV1PatchNodeProxyWithPathRequest,
  ReadCoreV1NodeStatusRequest,
  ReplaceCoreV1NodeStatusRequest,
  PatchCoreV1NodeStatusRequest,
  ListCoreV1PersistentVolumeClaimForAllNamespacesRequest,
  ListCoreV1PersistentVolumeRequest,
  CreateCoreV1PersistentVolumeRequest,
  DeleteCoreV1CollectionPersistentVolumeRequest,
  ReadCoreV1PersistentVolumeRequest,
  ReplaceCoreV1PersistentVolumeRequest,
  DeleteCoreV1PersistentVolumeRequest,
  ...
  PatchCoreV1PersistentVolumeStatusRequest,
  ...
  ListCoreV1ServiceAccountForAllNamespacesRequest,
  ListCoreV1ServiceForAllNamespacesRequest,
  WatchCoreV1ConfigMapListForAllNamespacesRequest,
  WatchCoreV1EndpointsListForAllNamespacesRequest,
  WatchCoreV1EventListForAllNamespacesRequest,
  WatchCoreV1LimitRangeListForAllNamespacesRequest,
  WatchCoreV1NamespaceListRequest,
  WatchCoreV1NamespacedConfigMapListRequest,
  WatchCoreV1NamespacedConfigMapRequest,
  WatchCoreV1NamespacedEndpointsListRequest,
  WatchCoreV1NamespacedEndpointsRequest,
  WatchCoreV1NamespacedEventListRequest,
  WatchCoreV1NamespacedEventRequest,
  ...
  // Additional API group request types
  ...
  WatchCoreV1ServiceListForAllNamespacesRequest,
  PodList,
  PodTemplate,
  PodTemplateList,
  ...
  DeleteCoreV1CollectionNamespacedPodTemplateRequest,
  ReadCoreV1NamespacedPodTemplateRequest,
  ReplaceCoreV1NamespacedPodTemplateRequest,
  DeleteCoreV1NamespacedPodTemplateRequest,
  PatchCoreV1NamespacedPodTemplateRequest,
  ReadCoreV1NamespacedReplicationControllerScaleRequest,
  ReplaceCoreV1NamespacedReplicationControllerScaleRequest,
  PatchCoreV1NamespacedReplicationControllerScaleRequest,
  ListCoreV1NamespacedResourceQuotaRequest,
  CreateCoreV1NamespacedResourceQuotaRequest,
  DeleteCoreV1CollectionNamespacedResourceQuotaRequest,
  ReadCoreV1NamespacedResourceQuotaRequest,
  ReplaceCoreV1NamespacedResourceQuotaRequest,
  ...
  ReadCoreV1NamespacedReplicationControllerRequest,
  ReplaceCoreV1NamespacedReplicationControllerRequest,
  DeleteCoreV1NamespacedReplicationControllerRequest,
  PatchCoreV1NamespacedReplicationControllerRequest,
  ReadCoreV1NamespacedReplicationControllerStatusRequest,
  ReplaceCoreV1NamespacedReplicationControllerStatusRequest,
  PatchCoreV1NamespacedReplicationControllerStatusRequest,
  Secret,
  SecretList,
  ListCoreV1NamespacedSecretRequest,
  CreateCoreV1NamespacedSecretRequest,
  DeleteCoreV1CollectionNamespacedSecretRequest,
  ReadCoreV1NamespacedSecretRequest,
  ...
  ConnectCoreV1GetNamespacedServiceProxyWithPathRequest,
  ConnectCoreV1PostNamespacedServiceProxyWithPathRequest,
  ConnectCoreV1PutNamespacedServiceProxyWithPathRequest,
  ConnectCoreV1DeleteNamespacedServiceProxyWithPathRequest,
  ConnectCoreV1PatchNamespacedServiceProxyWithPathRequest,
  ReadCoreV1NamespacedServiceStatusRequest,
  ReplaceCoreV1NamespacedServiceStatusRequest,
  PatchCoreV1NamespacedServiceStatusRequest,
  ReadCoreV1NamespaceRequest,
  ReplaceCoreV1NamespaceRequest,
  DeleteCoreV1NamespaceRequest,
  PatchCoreV1NamespaceRequest,
  ...
  CreateCoreV1NamespacedServiceRequest,
  ReadCoreV1NamespacedServiceRequest,
  ReplaceCoreV1NamespacedServiceRequest,
  DeleteCoreV1NamespacedServiceRequest,
  PatchCoreV1NamespacedServiceRequest,
  PatchCoreV1NamespaceStatusRequest,
  Node,
  NodeList,
  ListCoreV1NodeRequest,
  CreateCoreV1NodeRequest,
  DeleteCoreV1CollectionNodeRequest,
  ReadCoreV1NodeRequest,
  ReplaceCoreV1NodeRequest,
  DeleteCoreV1NodeRequest,
  PatchCoreV1NodeRequest,
  ConnectCoreV1GetNodeProxyRequest,
  ConnectCoreV1PostNodeProxyRequest,
  ConnectCoreV1PutNodeProxyRequest,
  ConnectCoreV1DeleteNodeProxyRequest,
  ConnectCoreV1PatchNodeProxyRequest,
  APIGroupList,
  GetAPIVersionsRequest,
...
const APIS_AUTOSCALING_V2_KEY = ["apis_autoscaling_v2"];
const APIS_AUTOSCALING_V2_HORIZONTALPODAUTOSCALERS_KEY = ["apis_autoscaling_v2_horizontalpodautoscalers"];
const APIS_AUTOSCALING_V2_NAMESPACES_NAMESPACE_HORIZONTALPODAUTOSCALERS_KEY = ["apis_autoscaling_v2_namespaces_namespace_horizontalpodautoscalers"];
const APIS_AUTOSCALING_V2_NAMESPACES_NAMESPACE_HORIZONTALPODAUTOSCALERS_NAME_KEY = ["apis_autoscaling_v2_namespaces_namespace_horizontalpodautoscalers_name"];
const APIS_AUTOSCALING_V2_NAMESPACES_NAMESPACE_HORIZONTALPODAUTOSCALERS_NAME_STATUS_KEY = ["apis_autoscaling_v2_namespaces_namespace_horizontalpodautoscalers_name_status"];
const APIS_AUTOSCALING_V2_WATCH_HORIZONTALPODAUTOSCALERS_KEY = ["apis_autoscaling_v2_watch_horizontalpodautoscalers"];
const APIS_AUTOSCALING_V2_WATCH_NAMESPACES_NAMESPACE_HORIZONTALPODAUTOSCALERS_KEY = ["apis_autoscaling_v2_watch_namespaces_namespace_horizontalpodautoscalers"];
const APIS_AUTOSCALING_V2_WATCH_NAMESPACES_NAMESPACE_HORIZONTALPODAUTOSCALERS_NAME_KEY = ["apis_autoscaling_v2_watch_namespaces_namespace_horizontalpodautoscalers_name"];
...
export function useDeleteCoreV1NamespacedService() {
  ...
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: async (request: DeleteCoreV1NamespacedServiceRequest) => {
...
// Autoscaling V2 API hooks
export function useGetAutoscalingV2APIResourcesQuery(params: GetAutoscalingV2APIResourcesRequest) {
  const client = useKubernetes().client;
  return useQuery<APIResourceList, Error>({
    queryKey: [...APIS_AUTOSCALING_V2_KEY],
    queryFn: async () => {
      return await client.getAutoscalingV2APIResources(params);
    },
    enabled: true
  });
}
...
export function useCreateAutoscalingV2NamespacedHorizontalPodAutoscaler() {
  const client = useKubernetes().client;
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: async (request: CreateAutoscalingV2NamespacedHorizontalPodAutoscalerRequest) => {
      return client.createAutoscalingV2NamespacedHorizontalPodAutoscaler(request);
    },
    onSuccess: (_, response: CreateAutoscalingV2NamespacedHorizontalPodAutoscalerRequest) => {
      queryClient.invalidateQueries({
        queryKey: [...APIS_AUTOSCALING_V2_NAMESPACES_NAMESPACE_HORIZONTALPODAUTOSCALERS_KEY, response.path.namespace]
      });
    }
  });
}

export function useDeleteAutoscalingV2CollectionNamespacedHorizontalPodAutoscaler() {
  const client = useKubernetes().client;
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: async (request: DeleteAutoscalingV2CollectionNamespacedHorizontalPodAutoscalerRequest) => {
      return client.deleteAutoscalingV2CollectionNamespacedHorizontalPodAutoscaler(request);
    },
    onSuccess: (_, response: DeleteAutoscalingV2CollectionNamespacedHorizontalPodAutoscalerRequest) => {
      queryClient.invalidateQueries({
        queryKey: [...APIS_AUTOSCALING_V2_NAMESPACES_NAMESPACE_HORIZONTALPODAUTOSCALERS_KEY, response.path.namespace]
      });
    }
...
export function useReadAutoscalingV2NamespacedHorizontalPodAutoscalerQuery(params: ReadAutoscalingV2NamespacedHorizontalPodAutoscalerRequest) {
  const client = useKubernetes().client;
  return useQuery({
    queryKey: [...APIS_AUTOSCALING_V2_NAMESPACES_NAMESPACE_HORIZONTALPODAUTOSCALERS_NAME_KEY, params.path.name, params.path.namespace],
    queryFn: async () => {
      return await client.readAutoscalingV2NamespacedHorizontalPodAutoscaler(params);
    },
    enabled: params.path.name !== undefined && params.path.namespace !== undefined
  });
}

export function useReplaceAutoscalingV2NamespacedHorizontalPodAutoscaler() {
  const client = useKubernetes().client;
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: async (request: ReplaceAutoscalingV2NamespacedHorizontalPodAutoscalerRequest) => {
      return client.replaceAutoscalingV2NamespacedHorizontalPodAutoscaler(request);
    },
    onSuccess: (_, response: ReplaceAutoscalingV2NamespacedHorizontalPodAutoscalerRequest) => {
      queryClient.invalidateQueries({
        queryKey: [...APIS_AUTOSCALING_V2_NAMESPACES_NAMESPACE_HORIZONTALPODAUTOSCALERS_NAME_KEY, response.path.name, response.path.namespace]
      });
    }
  });
}

export function useDeleteAutoscalingV2NamespacedHorizontalPodAutoscaler() {
  const client = useKubernetes().client;
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: async (request: DeleteAutoscalingV2NamespacedHorizontalPodAutoscalerRequest) => {
      return client.deleteAutoscalingV2NamespacedHorizontalPodAutoscaler(request);
    },
    onSuccess: (_, response: DeleteAutoscalingV2NamespacedHorizontalPodAutoscalerRequest) => {
      queryClient.invalidateQueries({
        queryKey: [...APIS_AUTOSCALING_V2_NAMESPACES_NAMESPACE_HORIZONTALPODAUTOSCALERS_NAME_KEY, response.path.name, response.path.namespace]
      });
    }
...
export function usePatchAutoscalingV2NamespacedHorizontalPodAutoscaler() {
  const client = useKubernetes().client;
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: async (request: PatchAutoscalingV2NamespacedHorizontalPodAutoscalerRequest) => {
      return client.patchAutoscalingV2NamespacedHorizontalPodAutoscaler(request);
    },
    onSuccess: (_, response: PatchAutoscalingV2NamespacedHorizontalPodAutoscalerRequest) => {
      queryClient.invalidateQueries({
        queryKey: [...APIS_AUTOSCALING_V2_NAMESPACES_NAMESPACE_HORIZONTALPODAUTOSCALERS_NAME_KEY, response.path.name, response.path.namespace]
      });
    }
...
export function useReadAutoscalingV2NamespacedHorizontalPodAutoscalerStatusQuery(params: ReadAutoscalingV2NamespacedHorizontalPodAutoscalerStatusRequest) {
  const client = useKubernetes().client;
  return useQuery({
    queryKey: [...APIS_AUTOSCALING_V2_NAMESPACES_NAMESPACE_HORIZONTALPODAUTOSCALERS_NAME_STATUS_KEY, params.path.name, params.path.namespace],
    queryFn: async () => {
      return await client.readAutoscalingV2NamespacedHorizontalPodAutoscalerStatus(params);
    },
    enabled: params.path.name !== undefined && params.path.namespace !== undefined
  });
}

export function useReplaceAutoscalingV2NamespacedHorizontalPodAutoscalerStatus() {
  const client = useKubernetes().client;
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: async (request: ReplaceAutoscalingV2NamespacedHorizontalPodAutoscalerStatusRequest) => {
      return client.replaceAutoscalingV2NamespacedHorizontalPodAutoscalerStatus(request);
    },
    onSuccess: (_, response: ReplaceAutoscalingV2NamespacedHorizontalPodAutoscalerStatusRequest) => {
      queryClient.invalidateQueries({
        queryKey: [...APIS_AUTOSCALING_V2_NAMESPACES_NAMESPACE_HORIZONTALPODAUTOSCALERS_NAME_STATUS_KEY, response.path.name, response.path.namespace]
      });
    }
  });
}

export function usePatchAutoscalingV2NamespacedHorizontalPodAutoscalerStatus() {
  const client = useKubernetes().client;
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: async (request: PatchAutoscalingV2NamespacedHorizontalPodAutoscalerStatusRequest) => {
      return client.patchAutoscalingV2NamespacedHorizontalPodAutoscalerStatus(request);
    },
    onSuccess: (_, response: PatchAutoscalingV2NamespacedHorizontalPodAutoscalerStatusRequest) => {
      queryClient.invalidateQueries({
        queryKey: [...APIS_AUTOSCALING_V2_NAMESPACES_NAMESPACE_HORIZONTALPODAUTOSCALERS_NAME_STATUS_KEY, response.path.name, response.path.namespace]
      });
    }
...
export function useWatchAutoscalingV2HorizontalPodAutoscalerListForAllNamespacesQuery(params: WatchAutoscalingV2HorizontalPodAutoscalerListForAllNamespacesRequest) {
  const client = useKubernetes().client;
  return useQuery<WatchEvent, Error>({
    queryKey: [...APIS_AUTOSCALING_V2_WATCH_HORIZONTALPODAUTOSCALERS_KEY],
    queryFn: async () => {
      return await client.watchAutoscalingV2HorizontalPodAutoscalerListForAllNamespaces(params);
    },
    enabled: true
  });
}

export function useWatchAutoscalingV2NamespacedHorizontalPodAutoscalerListQuery(params: WatchAutoscalingV2NamespacedHorizontalPodAutoscalerListRequest) {
  const client = useKubernetes().client;
  return useQuery<WatchEvent, Error>({
    queryKey: [...APIS_AUTOSCALING_V2_WATCH_NAMESPACES_NAMESPACE_HORIZONTALPODAUTOSCALERS_KEY, params.path.namespace],
    queryFn: async () => {
      return await client.watchAutoscalingV2NamespacedHorizontalPodAutoscalerList(params);
    },
    enabled: params.path.namespace !== undefined
  });
}

export function useWatchAutoscalingV2NamespacedHorizontalPodAutoscalerQuery(params: WatchAutoscalingV2NamespacedHorizontalPodAutoscalerRequest) {
  const client = useKubernetes().client;
  return useQuery<WatchEvent, Error>({
    queryKey: [...APIS_AUTOSCALING_V2_WATCH_NAMESPACES_NAMESPACE_HORIZONTALPODAUTOSCALERS_NAME_KEY, params.path.name, params.path.namespace],
    queryFn: async () => {
      return await client.watchAutoscalingV2NamespacedHorizontalPodAutoscaler(params);
    },
    enabled: params.path.name !== undefined && params.path.namespace !== undefined
  });
}
...
export function useCreateEventsV1NamespacedEvent() {
  ...
  return useMutation({
    ...
    onSuccess: (_, response: CreateEventsV1NamespacedEventRequest) => {
      queryClient.invalidateQueries({
...
export function useReplaceEventsV1NamespacedEvent() {
  ...
  return useMutation({
    ...
    onSuccess: (_, response: ReplaceEventsV1NamespacedEventRequest) => {
      queryClient.invalidateQueries({
...
// TO DO: Missing type export from interwebjs
