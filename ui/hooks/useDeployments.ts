...
export function useCreateDeployment() {
  ...
  return {
    ...
    mutate: ({ deployment, namespace }) =>
      mutation.mutate({ path: { namespace: namespace || defaultNamespace }, query: {}, body: deployment }),
    mutateAsync: ({ deployment, namespace }) =>
      mutation.mutateAsync({ path: { namespace: namespace || defaultNamespace }, query: {}, body: deployment }),
  }
}
...
export function useUpdateDeployment() {
  ...
  return {
    ...
    mutate: ({ name, deployment, namespace }) =>
      mutation.mutate({ path: { namespace: namespace || defaultNamespace, name }, query: {}, body: deployment }),
    mutateAsync: ({ name, deployment, namespace }) =>
      mutation.mutateAsync({ path: { namespace: namespace || defaultNamespace, name }, query: {}, body: deployment }),
  }
}
