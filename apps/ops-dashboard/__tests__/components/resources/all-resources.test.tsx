import { AppsV1DaemonSet, AppsV1Deployment, AppsV1ReplicaSet,Pod, Service } from '@kubernetesjs/ops';
import userEvent from '@testing-library/user-event';

import { 
  createDaemonSetsList} from '@/__mocks__/handlers/daemonsets';
import { 
  createDeploymentsList,
  createDeploymentsListError} from '@/__mocks__/handlers/deployments';
import { 
  createPodsList} from '@/__mocks__/handlers/pods';
import { 
  createReplicaSetsList} from '@/__mocks__/handlers/replicasets';
import { 
  createServicesList} from '@/__mocks__/handlers/services';
