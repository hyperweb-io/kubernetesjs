...
import { type RbacAuthorizationK8sIoV1ClusterRole as ClusterRole,type RbacAuthorizationK8sIoV1Role as Role } from '@kubernetesjs/ops';
import { 
  AlertCircle,
  Eye,
  Globe,
...
import { 
  ...
  useListRbacAuthorizationV1RoleForAllNamespacesQuery} from '@/k8s';
